...
dfnimar=pd.read_csv("myCSV.csv",index_col=['Sno'])
...
def fig():
    ...
    print("----------------------------------------------------------------------------------------")
    time.sleep(1)
    print(" __     __          __        __            __                  _______                     __        __                  ")
    print("/  |   /  |        /  |      /  |          /  |                /       \                   /  |      /  |                     ")
    print("$$ |   $$ |______  $$ |____  $$/   _______ $$ |  ______        $$$$$$$  |______    ______  $$ |   __ $$/  _______    ______  ")
    print("$$ |   $$ /      \ $$      \ /  | /       |$$ | /      \       $$ |__$$ /      \  /      \ $$ |  /  |/  |/       \  /      \ ")
    print("$$  \ /$$/$$$$$$  |$$$$$$$  |$$ |/$$$$$$$/ $$ |/$$$$$$  |      $$    $$/$$$$$$  |/$$$$$$  |$$ |_/$$/ $$ |$$$$$$$  |/$$$$$$  |")
    print(" $$  /$$/$$    $$ |$$ |  $$ |$$ |$$ |      $$ |$$    $$ |      $$$$$$$/ /    $$ |$$ |  $$/ $$   $$<  $$ |$$ |  $$ |$$ |  $$ |")
    print("  $$ $$/ $$$$$$$$/ $$ |  $$ |$$ |$$ \_____ $$ |$$$$$$$$/       $$ |    /$$$$$$$ |$$ |      $$$$$$  \ $$ |$$ |  $$ |$$ \__$$ |")
...
bicycles = 78
Sno = 1
dfnimar = pd.DataFrame(columns=['Sno', 'Vehicle_Number', 'Vehicle_Type', 'vehicle_Name', 'Owner_Name', 'Date', 'Time'])

def main():
    global Sno, bikes, cars, bicycles
    try:
        while True:
            print("----------------------------------------------------------------------------------------")
            print("\t\tParking Management System")
            ...
            if ch == 1:
                ...
                while t==True:
                    ...
                    if t=="":
                        ...
                        Time.append(time)
                        t=not True
                dfnimar.loc[Sno] = [Sno, Vno, Vtype, vname, OName, date, time]
                dfnimar.to_csv("myCSV.csv", index=False)
                Sno += 1
                print("\n............................................................Record detail saved..................................................................")
